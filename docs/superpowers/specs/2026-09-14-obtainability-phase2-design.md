...
| Repeatable chance routes (2026-09-16): Geode, Quartz, common gems, fishing trash, Bug Meat and the like | hard week 1 to 2 | LuckOnly (chance only) | Jeff: yes, a chance route the player can retry many times a day with a decent chance each try counts as dependable. The threshold and the resulting item list go to Jeff before the model changes. |
| Code routes the data files miss (2026-09-16): Fiber from weeds, tree seeds from trees, Salmonberry and Blackberry bushes, Clay, Cave Carrot and Snow Yam from tilling, Caroline's Tea Sapling recipe, beach forage | later, or chance only | missing | Jeff: yes, add them. Weeds, trees and tilling land week 1 (Snow Yam in Winter); bushes on their harvest days; Tea Sapling after Caroline's friendship plus the bush's 20 days; beach forage once the reason it is not read is found. Before and after per item goes to Jeff. |
| Plain luck (2026-09-16): geode minerals, artifacts, fossils, rare dig finds (Chipped Amphora, Skeletal Hand, Warp Totem: Mountains), Dwarf Scrolls, chance-seed crops, slime eggs, Caviar, rotating Bookseller stock | some at week 1 | chance only | Jeff: yes, the new model stands. |
| Treasure Chest; Midnight Squid, Spook Fish, Blobfish (2026-09-16) | 5; 13 | 14 (Squid Fest); 15 (Night Market submarine) | Jeff: yes, the new model stands. |
| Ginger Island items and year 2 Bookseller books (2026-09-16) | year 1 routes | none | Jeff: yes, out of scope as the spec already says. |
| (O)MysteryBox Mystery Box (2026-09-16) | 2 | 3 (Desert Festival egg shop) | Jeff: dependable only from the Qi plane (sawQiPlane: 6th Help Wanted quest, or day 51 at the latest, Utility.cs 4409-4413); after it, the random finds (trees, fishing, crates, panning, tilling; Utility.tryRollMysteryBox) count as repeatable. |
| (O)107 Dinosaur Egg and other not-sold animals' produce (2026-09-16) | 1 | 2 (Dinosaur produce) | Jeff: from nothing it is chance only (Skull Cavern dino floors 6%, MineShaft.cs 3939-3944; dig spots; fishing chests; cart). Dependable only with the animal already owned, on its production cycle. Every hatched or young animal also waits out its growing-up days. Same for Void and Golden Chickens. |
| Desert shop and festival routes (2026-09-16, found during the rulings) | n/a | shop:DesertFestival_*, DesertTrade and the desert shops counted as met | Jeff: yes, fix. Every desert shop or stall route requires the bus (ccVault) like location:Desert does. |
| (O)774 Wild Bait (2026-09-16) | 1 | 3, recipe unlock unresolved | Jeff: read Linus's friendship unlock with the other missing routes. |
| (O)908 Magic Bait (2026-09-16) | n/a | no source, unresolved | Jeff: a Ginger Island item (both routes run through Mr. Qi), out of scope; it leaves the unresolved count and the Beach Magic Bait rows stay island only. |
| (O)24 Parsnip from Summer 1 (2026-09-16) | n/a | week 15 via Night Market seeds and the greenhouse | Jeff: the new model stands; the greenhouse is checked against the save. |
| LocationSpawn.Chance (2026-09-16) | n/a | carried, unread | Jeff: keep it; the repeatable-chance threshold may read chance values. |
| Repeatable chance threshold (2026-09-16) | n/a | chance only | Jeff: approved as proposed in docs/superpowers/notes/2026-09-16-repeatable-chance-proposal.md: mine stone rows (coal, gems, geode, frozen geode, magma geode, omni geode) are dependable except the diamond node; a monster drop is dependable when that item's own roll on the monster's drop list is 25% or better (each item rolls separately, Monster.cs 428-434); fishing trash is dependable. Ordinary fish and machine output are reviewed separately (TODO). |
| Mine depth in the landing week (2026-09-16) | n/a | floors recorded as a condition only | Jeff: the report must be as accurate as possible, so a mine-floor route lands after the days it takes to get there at 10 floors a day from nothing (floor N: max(0, ceil(N/10) - 1) days, so floors 1 to 10 land the day you start, floor 40 on day 4, floor 80 on day 8). The darkness check credits the depth the save has already reached, so nothing is counted twice. Skull Cavern needs the mines cleared (2026-09-16): the Skull Key that opens the cavern is the chest reward for reaching floor 120, the mine's bottom (MineShaft.cs 2188-2196), so a Skull Cavern route prices as floor 121 (day 13 from nothing) and, alongside the bus and Staircase conditions, the darkness check also prices a save that has not reached floor 120: free once it has, MineGapDays(deepest, 120) on Normal and Hard, and Easy rules the route out while the mines are not cleared. |
| (O)289 Ostrich Egg (2026-09-16) | 2 | no route | Jeff: out of scope for year 1, like the other Ginger Island items (the ostrich is not sold and its incubator is an island recipe). Closed. |
