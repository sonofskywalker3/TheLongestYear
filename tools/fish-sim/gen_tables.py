...
SKIP={'Skeleton Warrior','Iridium Golem','Wilderness Golem','Fireball','Crow','Frog','Cat','Skeleton Mage','Pepper Rex','Tiger Slime','Lava Lurk','Hot Head','Magma Sprite','Magma Duggy','Magma Sparker','False Magma Cap','Dwarvish Sentry','Putrid Ghost','Shadow Sniper','Spider','Royal Serpent','Blue Squid','Truffle Crab'}
KILLS=60*7
SKULL={'Iridium Bat','Iridium Crab','Mummy','Serpent','Carbon Ghost'}   # Skull Cavern: a third of the kill rate
best={}
for mon,v in monsters.items():
    ...
    for item,ch in per.items():
        exp=(KILLS/3 if mon in SKULL else KILLS)*ch
