...
# Honour an absolute path; only fall back to script-relative for a bare filename. The old
# behaviour silently wrote next to the script, so callers passing a full path got "saved"
# messages pointing at files that were not where they asked for them.
