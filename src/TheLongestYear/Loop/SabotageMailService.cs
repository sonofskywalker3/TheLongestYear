...
namespace TheLongestYear.Loop
{
    ...
    /// blight, Shane for a donation coming undone. The board changing is the Junimos' own scene,
    /// not a letter (Jeff, 2026-09-09). Once per save
    ...
    internal sealed class SabotageMailService
    {
        ...
        /// <summary>Register the two letter bodies in Data/Mail. Hooked from ModEntry.Entry.</summary>
