...
namespace TheLongestYear.Integration
{
    ...
    internal sealed class IntroEventInjector
    {
        ...
        internal static string BuildIntroEvent() => string.Join("/", new[]
        {
            ...
            "pause 400",
            "speak Junimo \"Hello, @. We are the spirits of this land — the Junimos.#$b#Few folk can see us anymore.$h\"",
            "pause 200",
            "speak Junimo \"Long ago, the people of this valley worked the soil together and shared what nature gave them.#$b#In that kindness we flourished, and this old hall was the heart of it.$h\"",
            "pause 200",
            "speak Junimo \"But the world grew busy — they chased coin and comfort, and forgot one another.#$b#The shared work stopped, the hall fell quiet, and the spirit of the land thinned.#$b#As the people drifted apart, we faded with them, until there was nothing left to wake for. And so we slept.$s\"",
            "pause 300",
            "speak Junimo \"Lately, though, we feel a stirring.#$b#The people are weary of their 'progress,' and miss what they traded away — the valley whole, and alive.#$b#That longing is what woke us... that, and you.$h\"",
            "pause 300",
            "speak Junimo \"We can make the land strong again — but not alone, and neither can you.#$b#Work the soil. Draw the townsfolk back together.#$b#As they share in the land's bounty once more, our power returns, and this hall is restored.$h\"",
            "pause 400",
            "speak Junimo \"But the seasons bind you, @. Each one asks its share.#$b#Bring enough of the land's bounty to this hall before a season turns.#$b#Fall short, and the year unwinds to spring — and you begin again.$s\"",
            "pause 300",
            "speak Junimo \"Even keeping pace, a single year is too short to make the valley whole.#$b#You will not finish on this first turning.#$b#When the year unwinds, what grows in the ground is lost...$s\"",
            "pause 300",
            "speak Junimo \"...but what grows between people is not.#$b#Every season worked, every bond mended, every harvest shared.#$b#That spirit stays with us, and eases the next turning.$h\"",
            "pause 300",
