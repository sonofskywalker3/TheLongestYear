...
This is a **beta** (`0.17.2`). It is feature-complete for v1 and stable in testing; what it most needs now is feedback on **difficulty, pricing, and pacing**. See [Giving feedback](#giving-feedback).
...
- **0.17.2: the Skip intro checkbox is back.** Rerolling farms? Tick Skip intro on the character screen and the opening scene is skipped, straight to the theme picker. A note pops up recommending you watch it the first time, since it is the only in-game explanation of the loop. Asked for by gazumbrado.
- **0.17.2: new book art.** The Cookbook, Craftbook and Bundle Log have proper covers now, drawn by **supercam19**. Thank you!
