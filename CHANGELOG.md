...
- **At most one fruit-tree fruit per weekly goal list.** A Spring week 2 Farming list named three tree fruits (Jeff, 2026-08-29). Each theme's goals now hold at most one fruit from Data/FruitTrees; the cap is per theme list, not per season gate, and modded fruit trees count.
